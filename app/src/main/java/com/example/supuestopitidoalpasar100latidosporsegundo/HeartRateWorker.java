...
public class HeartRateWorker extends Worker {
    ...
    private void saveExtendedAnalysis(double average, long min, long max, double stdDev) {
        ...
        db.collection("heart_rate_analysis_summary").add(data)
                .addOnSuccessListener(docRef -> Log.d("HeartRateWorker", "Resumen guardado: " + docRef.getId()))
                .addOnFailureListener(e -> Log.e("HeartRateWorker", "Error al guardar resumen", e));
    }
